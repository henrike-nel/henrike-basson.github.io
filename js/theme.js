$(function () {
    ...
    function int_introHeight() {
        ...
        if (isMobileViewport) {
            // Mobile browsers change viewport height while scrolling.
            // Avoid pinning hero height to prevent jumpy scroll behavior.
            $('.js-fullscreen-height').css('height', '');
            return;
        }
    ...
    function int_Elements() {
        ...
        $('.tabs a').click(function (e) {
            e.preventDefault();
            var $this = $(this), tabgroup = '#' + $this.parents('.tabs').data('tabgroup'), others = $this.closest('li').siblings().children('a');
